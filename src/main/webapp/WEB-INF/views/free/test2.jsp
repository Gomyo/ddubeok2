		...
		success:function(data){
			...
			text1+= '<p>'+data.length+'건의 데이터가 있습니다.</p>';
				...
				for(var i = 0; i<data.length;i++){
					...
					result3 += '<div class="card" style="width: 400px; height:400px; padding-right:10px;">';
					result3 += '<img src="'+ img +'" alt="" class="card-img-top" style="width:100%; height:75%;">';
					result3 += '<div class="card-body" style="width: 100%; height:25%;">';
					result3 += '<h4 class="card-title" style="margin-left: 10px;">'+ title +'</h4>';
     

					result3 +='<button type="button" class="btn btn-outline-success btn-sm" data-toggle="modal" data-target="#myModal'+i+'">자세히보기</button>';
					result3 +='<button type="button" class="btn btn-outline-danger btn-sm"><i class="far fa-heart"></i></button>';
					result3 +='</div>';
					result3 +='</div>';
					result3 +='</div>';	
	...
	$.ajax({
		...
		success:function(data){
			...
			for(var i =0; i<9; i++){
				...
				weather += '<div class="weather_box" style="width:100%; height:400px; opacity: 100%; border-radius: 20px; background-image:url(\'';
...
<div class="wrap"  style="width:100%;">
	...
	<div class="main-content" style="background-color:white;">
        ...
        <div class="ftco-blocks-cover-1">
            <div class="site-section-cover" style="height: 900px;  background-image: url('/resources/image/hero_1.jpg'); transform: scaleX(-1); overflow-y: hidden;">
                ...
                <div class="info_box" id="info_box" style="width: 50%; height:50%; transform: scaleX(-1); padding-top:10%; padding-right: 100px; ">
                    ...
                    <div class="map_box" style="width: 80%; margin-left: 10%; padding-bottom:10%;">
                        <h1 style="color: black; margin-left:20px; margin-bottom:10px;">지도 찾기</h1>
...
<div class="navigation_bar" style="position: fixed; font-size: 1.5rem; margin-left: 100px; margin-top: 12%;">
	...
	<script src="/resources/js2/bootstrap-datepicker.min.js"></script>
 	<script src="/resources/js2/jquery-3.3.1.min.js"></script>
    <script src="/resources/js2/jquery-migrate-3.0.0.js"></script>
